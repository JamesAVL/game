...
export const CRIMPS = {
  ...
  jazz: crimp({
    ...
    mechanic: { type: "swing", rate: 0.22, seed: 210 },
  ...
  gregg: crimp({
    ...
    mechanic: { type: "hold", rate: 0.34, min: 0.5, max: 1.2, seed: 440 },
  ...
  crackfox: crimp({
    ...
    mechanic: { type: "fog", y0: 0.30, y1: 0.62 },
  ...
  nana: crimp({
    ...
    mechanic: { type: "hex", rate: 0.12, seed: 1310 },
  ...
  moon: crimp({
    ...
    mechanic: { type: "drift", amp: 0.06, speed: 0.9 },
  ...
  tony: crimp({
    ...
    mechanic: { type: "outrage", everyBars: 8, lenBars: 2 },
